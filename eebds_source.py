...
if len(sys.argv) > 1 and sys.argv[0].endswith('eebds.py'):
    ...
    with open(sys.argv[1]+".copyright.PLEASE.INPUT.YOUR.COPYRIGHT.INFO.INSIDE.txt","w+") as f:
        f.write("This is your copyright info text. Just delete all these texts and input yours.\n这里输入您的版权信息。您可以移除此处所有文本然后填写您的信息\n")
